...
Ext.onReady(function(){
            mainTabs = new Ext.TabPanel({
                ...
                items:[{
                      ...
                      listeners: {activate: function(){Ext.getCmp('centerPanel').setTitle('${welcomePageTitle}');}},
...
<tr>
<td width="33%"><nobr>&nbsp;<img class="IEPNG" src="./resource/image/ext/comments2.png" />
&nbsp;${welcome},${username}!&nbsp;您的用户名:${account}&nbsp;所属部门:${deptname}</nobr></td>
<td width="33%"><div align="center"><nobr>${copyright}</nobr></div></td>
<td width="32%"><div align="right"><nobr>${date} ${week} <span id="rTime"><span></nobr></div></td>
<td width="1%"><div align="left"><nobr>&nbsp;&nbsp;</nobr></div></td>
</tr>
</table>
</div>
